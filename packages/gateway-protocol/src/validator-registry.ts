...
export const validateChatBookmarksListParams = compile(S.ChatBookmarksListParamsSchema);
export const validateChatBookmarksCreateParams = compile(S.ChatBookmarksCreateParamsSchema);
export const validateChatBookmarksRenameParams = compile(S.ChatBookmarksRenameParamsSchema);
export const validateChatBookmarksRemoveParams = compile(S.ChatBookmarksRemoveParamsSchema);
